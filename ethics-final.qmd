...
![](figures/plag-ethics){width="60%" fig-align="center"}
...
exams2forms(quiz_plagiarism, solution = FALSE)
```
...
#exams2forms(exm, n = 3)
exams2forms(test_plagiarism, solution = FALSE)
```
...
exams2forms(quiz_ai, solution = FALSE)
```
...
exams2forms(quiz_misconduct, solution = FALSE)
```
...
exams2forms(quiz_sources, solution = FALSE)
```
...
### Policies and Frameworks Regarding Safe Data Usage
...
exams2forms(quiz_sensitive, solution = FALSE)
```
...
exams2forms(quiz_quality, solution = FALSE)
```