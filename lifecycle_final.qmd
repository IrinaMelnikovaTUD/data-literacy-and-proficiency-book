...
exams2forms(quiz_lifecycle_model, solution = FALSE)
```
...
exams2forms(quiz_dmp, solution = FALSE)
```
...
exams2forms(quiz_lc_actions, solution = FALSE)
```
...
exams2forms(quiz_proc_n_clean, solution = FALSE)
```
...
exams2forms(quiz_metadata, solution = FALSE)
```
...
exams2forms(quiz_db, solution = FALSE)
```
...
exams2forms(quiz_lakes, solution = FALSE)
```
...
exams2forms(quiz_dm_software, solution = FALSE)
```
