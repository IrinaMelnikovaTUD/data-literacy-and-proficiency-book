...
![](figures/dcc-lc-model){width="60%" fig-align="center"}
...
exams2forms(list("model-purp.Rmd", "why-meta.Rmd", "preserve-stage.Rmd", "format-outdate.Rmd", "docu-data.Rmd", "usable-data.Rmd", "descr-repr.Rmd", "comm-part.Rmd", "migration.Rmd", "delete.Rmd"), solution = FALSE)
```
...
exams2forms(list("dmp-goal.Rmd", "dmp-research.Rmd", "state-purp-dmp.Rmd", "data-def.Rmd", "metadata-perk.Rmd", "coll-acc.Rmd", "dmp-sens.Rmd", "dmp-faq.Rmd", "data-lim.Rmd", "dmp-sw.Rmd"), solution = FALSE)
```
...
exams2forms(list("ex1-lc.Rmd", "quali-data.Rmd", "ordinal-data.Rmd", "discrete-data.Rmd", "primary-data.Rmd", "gov-second.Rmd", "contin-range.Rmd", "qual-method.Rmd", "synth-data.Rmd", "collect-relevance.Rmd"), solution = FALSE)
```
...
exm <- list(
  ...
  file.path(exercise_directory, "raw-dat.Rmd"),
...
exams2forms(list("preproc.Rmd", "raw-data.Rmd", "data-proc.Rmd", "clean-purp.Rmd", "miss-vals.Rmd", "data-transform.Rmd", "normal.Rmd", "dat-integrat.Rmd", "etl.Rmd", "proc-perk.Rmd"), solution = FALSE)
```
...
exams2forms(list("meta-basic.Rmd", "meta-help.Rmd", "maint.Rmd", "encr-sec.Rmd", "repo.Rmd", "dataset-context.Rmd", "backup-risk.Rmd", "local-control.Rmd", "integrity.Rmd", "stor-monitor.Rmd"), solution = FALSE)
```
...
exams2forms(list("rel-db.Rmd", "rel-mod.Rmd", "prim-key.Rmd", "for-key.Rmd", "sql-db.Rmd", "sql-sel.Rmd", "norm-db.Rmd", "not-null.Rmd", "row-db.Rmd", "db-use.Rmd"), solution = FALSE)
```
...
exams2forms(list("lake-base.Rmd", "lake-base.Rmd", "sch-read.Rmd", "sch-write.Rmd", "hdfs.Rmd", "swamp.Rmd", "lakes-ml.Rmd", "lakes-prob.Rmd", "lakehouse.Rmd", "lake-meta.Rmd"), solution = FALSE)
```
...
exams2forms(list("bi-purp.Rmd", "bi-tool.Rmd", "dbms.Rmd", "pg-sql.Rmd", "apache.Rmd", "etl-sw.Rmd", "talend.Rmd", "cloud-perk.Rmd", "big-cl.Rmd", "dash.Rmd"), solution = FALSE)
```
