...
exams2forms(list("meta-basics.Rmd", "meta-help.Rmd", "maint.Rmd", "encr-sec.Rmd", "repo.Rmd", "dataset-context.Rmd", "backup-risk.Rmd", "local-control.Rmd", "integrity.Rmd", "stor-monitor.Rmd"), solution = FALSE)
```
